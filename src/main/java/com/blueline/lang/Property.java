package main.java.com.blueline.lang;
...
//			prop.getProperty(keys).in
	...
	private static Properties getProperties(@NotNull Map<String,String> map){
	...
	public static <V>V  get(String propertyName,V defaultValue){
		...
		value=(value==null)?FINAL_PROPERTIES.getProperty(linuxPropertyName,null):value;
		if(value!=null){
	...
	private static void printProperties(@NotNull Properties pro){
